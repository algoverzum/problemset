...
### Bemenet
A bemenet első sorában egy egész szám található: $N$ – az ingek száma.

A második sorban egy egész szám található: $K$ – Nena zsebpénze petákban.

A következő $N$ sor mindegyike egy-egy egész számot tartalmaz, az ingek árát. Az $i$-edik sorban a $P_i$ ár szerepel.
