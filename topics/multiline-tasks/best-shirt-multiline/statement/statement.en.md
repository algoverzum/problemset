...
### Input
The first line of the input contains a single integer, $N$, the number of shirts.

The second line contains a single integer, $K$, Nena's amount of money in liards.

Each of the next $N$ lines contains a single integer representing the price of a shirt. The $i$-th of these lines contains the price $P_i$.
