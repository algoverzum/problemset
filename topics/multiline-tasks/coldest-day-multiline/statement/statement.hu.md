...
### Bemenet
A bemenet első sorában egyetlen egész szám van: $N$ - a napok száma.

A következő $N$ sor mindegyike egy-egy egész számot tartalmaz, az egyes napok hőmérsékletét. Az $i$-edik sorban a $T_i$ hőmérséklet szerepel.
