...
![Egy megfelelő nehézségű verseny összeállítása nehezebb, mint
gondolnád.](problemsetting.jpg){width="60%"}
...
`problemsetting.*` nevű fájlokat, melyek a bemeneti adatok beolvasását
...
-   $2 \le N \le \constraints{MAXN}$.

-   $0 \le A_i \le \constraints{MAXA}$ minden $i=1 \ldots N$-re.

-   $0 \le B_i \le \constraints{MAXB}$ minden $i=1 \ldots N-1$-re.
