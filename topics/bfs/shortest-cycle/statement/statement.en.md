...
The second line should contain $K$ distinct city indices in order, forming a $K$ length cycle in the input graph, assuming that the edge from the last city back to the first is included. If multiple valid solutions exist, any of them may be given.
