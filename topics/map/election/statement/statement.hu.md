...
A következő $N$ sorban egy $S_i$ string és egy $A_i$ egész szám van szóközzel elválasztva, a jelölt neve és a hozzá tartozó szavazatok száma.
...
### Korlátok
* $1 \le N \le 1000$
* $S_i$ csak angol kisbetűket tartalmaz és hossza legfeljebb 10 minden $1 \le i \le N$ esetén
