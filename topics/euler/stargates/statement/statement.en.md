...
### Input
The first line of the input contains two integers: $N$ is the number of planets in the system and $M$ is the number of stargates. <br>
The planets are denoted by $1, \ldots, N$.<br>
This is followed by $M$ lines , each line has two distinct numbers $V_i$ and $V_j$ the two planets connected by the edge.
