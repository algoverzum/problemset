## Biodiversity
We want to collect the identities of all living things on a planet. To do this, we sent out two teams to search two different parts of the planet. Both teams sent a list of the identities of the organisms they found. Your task is to write out all the identifiers that appear on at least one of the lists.
