## Boldogság
A USS Enterprise fedélzetére új rakomány érkezett, amiben $N$ láda van. A szállítmány minden ládáját egy azonosító számmal jelölik.

A Csillagflotta két, egyenként $M$ elemű listát is átadott:
...
A végén jelentsed be a végső boldogság faktort.

### Bemenet
Az első sorban az $N$ és $M$ egész számok vannak szóközzel elválasztva, a ládák száma, illetve az $A$ és $B$ listák hossza.
...
* $A$ és $B$ diszjunkt, azaz nincs közös elemük
...
### A példa magyarázata
Az $A$ halmaz 3 és 1 elemei boldogságot szereznek. A $B$ halmazban az 5 miatt veszítesz egyet. 9 nem változtat semmin.
