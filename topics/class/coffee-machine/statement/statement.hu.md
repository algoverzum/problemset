...
* `get_status()`: Egy "getter" függvény, amely nem módosít semmit, csak visszaad egy formázott szöveget a gép aktuális állapotáról (márka, be van-e kapcsolva (0/1), víz- és kávészint). Pl.: "ABC 1 100 5"-t ha a márkája ABC, be van kapcsolva, 100 ml víz van benne és 5 g kávé. 
