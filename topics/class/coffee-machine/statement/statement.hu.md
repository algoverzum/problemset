...
* `set_water()`: Vár egy szám paramétert. Hozzáadja a megadott mennyiséget a gép jelenlegi vízkészletéhez.
* `set_coffee(self, amount)`: Vár egy szám paramétert. Hozzáadja a megadott mennyiséget a gép jelenlegi kávékészletéhez.
...
* `get_status()`: Egy "getter" függvény, amely nem módosít semmit, csak visszaad egy formázott szöveget a gép aktuális állapotáról (márka, be van-e kapcsolva (0/1), víz- és kávészint). Pl.: "ABC ON 100ml 5g"-t ha a márkája ABC, be van kapcsolva, 100 ml víz van benne és 5 g kávé. 
