...
The weather forecast has given the expected minimum and maximum temperatures for the next $N$ days. What will be the largest daily temperature variation? (That is, how large can the difference be between the maximum temperature and the minimum temperature for that day?)
...
The first day $15-10=5$ is the temperature fluctuation. Then $8-4=4$, $-1-(-5)=4$, $0-(-2)=2$, $1-(-5)=6$. The maximum of these is 6.
