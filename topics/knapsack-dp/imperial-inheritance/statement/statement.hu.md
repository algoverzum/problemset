...
$N$ bolygó van, amelyeket $1$-től $N$-ig sorszámoznak. Minden bolygónak ismert az értéke, amit egy pozitív egész $V_i$ számmal jellemeznek. A testvérek igazságos örökségre törekednek, tehát olyan elosztást keresnek, ahol mindketten ugyanakkora összértékű bolygót birtokolnak.
...
A második sorban $N$ pozitív egész szám van: $V_1, V_2, \ldots V_N$, a bolygók értékei.  
...
A második és harmadik sorba írd ki azoknak a bolygóknak a sorszámát, amelyeket az egyik, illetve a másik örökös kapott. Több megfelelő megoldás is létezhet — bármelyik elfogadható.
