...
It is possible that the weights of the crates in the cargo sum up to $2+2+2+2+2+2+2+2+2+3=21$, and in this case, their values would sum up to $1+1+1+1+1+1+1+1+1+2=11$. This is the minimum possible value for the cargo.
