...
Write a program that determines the minimum number of new cloaking generators required and specifies the stations where they should be installed so that every observation station lies within the protection of at least one new cloaking field.
