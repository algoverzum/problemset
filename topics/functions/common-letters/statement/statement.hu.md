...
### Sablon
Indulj ki az előre megadott sablon kódból! Ne változtass a főprogramon semmit, mert különben nem lesz elfogadva. Egy `common_letters` nevű függvényt kell definiálnod. Ügyelj arra, hogy a megadott nevű függvényt definiáld, megfelelő paraméterekkel és visszatérési típussal.
