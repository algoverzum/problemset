...
### Template
Start from the predefined template code. Do not change anything in the main program, otherwise it will not be accepted. You have to define a function called `common_letters`. Make sure you define a function with the given name, with the correct parameters and return type.
